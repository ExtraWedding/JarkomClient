...
<section class="problem mt-0" id="home" style="background-color:rgb(3, 135, 23);">
  <div class="container">
    <div class="row d-flex justify-content-center" data-aos="fade-up"data-aos-duration="3000">
        <div class="col-12">
        <div class="container">
        <h1 class="text-center fw-bold">FORM KETERSEDIAAN BUKU PERPUSTAKAAN</h1>
        <form id="dataForm" onsubmit="return confirm('Apakah anda yakin ingin mendaftar ?')" class="d-inline">
            ...
            <label for="pengarang" class="label-form">Penulis</label>
            <input type="text" class="form-control" id="pengarang" name="pengarang" required>

            <label for="kategori" class="label-form">Kategori</label>
            ...
            <label for="bahasa" class="label-form">Bahasa</label>
            ...
            <label for="penerbit" class="label-form">Penerbit</label>
            <input type="text" class="form-control" name="penerbit" id="penerbit">

            <label for="tanggal_publikasi" class="label-form">tanggal_publikasi</label>
